...
///////////////////////////////////////////////////////////////////////
// Modifications for Local Test Harness project:                     // 
// added #include "../TestHarnessUtilities/TestElement.h"  	         //
...
#include <vector>
#include <iostream>
// added for Local Test Harness project
...
public:
	...
	std::string& xml();
	// added for Local Test Harness project
	std::vector<TestElement> parseXmlIntoVectorOfTestElements();
private:
	// source string
	std::string _xml;
	size_t _position;
